...
public class Player : MonoBehaviour
{
    ...
    public GameObject firePositionRightInner;     //총 발사 위치
    public GameObject firePositionLeftInner;     //총 발사 위치
    public GameObject firePositionRightOuter;     //총 발사 위치
    public GameObject firePositionLeftOuter;     //총 발사 위치
